...
INSERT INTO users (id, name, email, password, role, manager_id) VALUES
    ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Alice Johnson', 'alice@st6.com', 'password', 'MANAGER', NULL) ON CONFLICT DO NOTHING;
INSERT INTO users (id, name, email, password, role, manager_id) VALUES
    ...
    ('d4e5f6a7-b8c9-0123-defa-234567890123', 'Dan Wilson', 'dan@st6.com', 'password', 'EMPLOYEE', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('10000000-0000-0000-0000-000000000002', 'Achieve operational excellence across all teams', 'RALLY_CRY', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('20000000-0000-0000-0000-000000000002', 'Grow user base by 40%', 'DEFINING_OBJECTIVE', '10000000-0000-0000-0000-000000000001') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('20000000-0000-0000-0000-000000000004', 'Implement CI/CD best practices across all repos', 'DEFINING_OBJECTIVE', '10000000-0000-0000-0000-000000000002') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('30000000-0000-0000-0000-000000000003', 'Advanced reporting dashboard launched', 'OUTCOME', '20000000-0000-0000-0000-000000000001') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('30000000-0000-0000-0000-000000000005', 'Marketing site redesign complete', 'OUTCOME', '20000000-0000-0000-0000-000000000002') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('30000000-0000-0000-0000-000000000007', 'Runbook coverage at 100% for critical services', 'OUTCOME', '20000000-0000-0000-0000-000000000003') ON CONFLICT DO NOTHING;
...
INSERT INTO goal_nodes (id, title, level, parent_id) VALUES
    ...
    ('30000000-0000-0000-0000-000000000009', 'Deploy frequency increased to daily', 'OUTCOME', '20000000-0000-0000-0000-000000000004') ON CONFLICT DO NOTHING;

-- Weeks
INSERT INTO weeks (id, start_date, end_date) VALUES
    ('a0000000-0000-0000-0000-000000000002', '2026-03-23', '2026-03-27'),
    ('a0000000-0000-0000-0000-000000000001', '2026-03-30', '2026-04-03') ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000003', 'Draft hiring plan for Q4', 'KNIGHT', NULL, 'Internal planning - no goal yet', TRUE, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a0000000-0000-0000-0000-000000000002', NULL, 'CARRY_FORWARD') ON CONFLICT DO NOTHING;
...
INSERT INTO reconciliation_entries (id, commit_id, done, explanation) VALUES
    ...
    ('e0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000003', FALSE, 'Waiting on headcount approval from finance') ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000005', 'Write payment integration tests', 'QUEEN', '30000000-0000-0000-0000-000000000001', NULL, FALSE, 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'a0000000-0000-0000-0000-000000000002', NULL, 'LOCKED') ON CONFLICT DO NOTHING;

INSERT INTO reconciliation_entries (id, commit_id, done, explanation) VALUES
    ('e0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000004', TRUE, NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000012', 'Review SSO architecture proposal', 'QUEEN', '30000000-0000-0000-0000-000000000002', NULL, FALSE, 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a0000000-0000-0000-0000-000000000001', NULL, 'DRAFT') ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000015', 'Fix flaky CI pipeline', 'PAWN', NULL, 'Tech debt cleanup', TRUE, 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'a0000000-0000-0000-0000-000000000001', NULL, 'DRAFT') ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000018', 'Write referral API endpoint tests', 'KNIGHT', '30000000-0000-0000-0000-000000000004', NULL, FALSE, 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'a0000000-0000-0000-0000-000000000001', NULL, 'DRAFT') ON CONFLICT DO NOTHING;
...
INSERT INTO weekly_commits (id, name, priority, goal_id, custom_goal_text, is_custom_goal, owner_id, week_id, carried_over_from, status) VALUES
    ...
    ('c0000000-0000-0000-0000-000000000021', 'Attend company all-hands', 'PAWN', NULL, NULL, FALSE, 'd4e5f6a7-b8c9-0123-defa-234567890123', 'a0000000-0000-0000-0000-000000000001', NULL, 'DRAFT') ON CONFLICT DO NOTHING;
